...
description <<desc
This command creates a new markdown blog post under content/posts/example.md. 
...
run do |opts, args, cmd|
  ...
  filename = "#{dir}/#{timestamp.year}-#{'%02d' % timestamp.month}-#{'%02d' % timestamp.day}-#{name}.html"
